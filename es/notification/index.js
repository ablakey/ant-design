...
function getGlobalContext() {
  ...
  const mergedPrefixCls =
    globalPrefixCls !== null && globalPrefixCls !== void 0
      ? globalPrefixCls
      : globalConfig().getPrefixCls('notification');
  const mergedContainer =
    (globalGetContainer === null || globalGetContainer === void 0
      ? void 0
      : globalGetContainer()) || document.body;
  return {
...
function flushNotice() {
  if (!notification) {
    ...
    act(() => {
      render(
        /*#__PURE__*/ React.createElement(GlobalHolder, {
          ref: (node) => {
...
function setNotificationGlobalConfig(config) {
  ...
  act(() => {
    var _a;
    (_a = notification === null || notification === void 0 ? void 0 : notification.sync) === null ||
    _a === void 0
      ? void 0
