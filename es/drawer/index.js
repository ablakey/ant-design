...
function Drawer(props) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    if (
      ...
      ((_a = props.style) === null || _a === void 0 ? void 0 : _a.position) === 'absolute'
    ) {
      process.env.NODE_ENV !== 'production'
        ? warning(
            false,
  ...
  const mergedHeight = React.useMemo(
    () => (height !== null && height !== void 0 ? height : size === 'large' ? 736 : 378),
    [height, size],
  );
  // =========================== Motion ===========================
  const maskMotion = {
...
function PurePanel(_a) {
  var { prefixCls: customizePrefixCls, style, className, placement = 'right' } = _a,
