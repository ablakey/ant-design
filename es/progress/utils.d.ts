...
export declare function getSuccessPercent({ success, successPercent }: ProgressProps):
  | number
  | undefined;
...
export declare const getStrokeColor: ({ success, strokeColor }: Partial<CircleProps>) => (
  | string
