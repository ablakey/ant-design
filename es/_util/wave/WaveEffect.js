    ...
    CSSMotion,
    {
      ...
      onAppearEnd: (_, event) => {
        ...
        if (event.deadline || event.propertyName === 'opacity') {
          const holder =
            (_a = divRef.current) === null || _a === void 0 ? void 0 : _a.parentElement;
          unmount(holder).then(() => {
            var _a;
...
export default function showWaveEffect(node, className) {
  ...
  node === null || node === void 0
    ? void 0
    : node.insertBefore(holder, node === null || node === void 0 ? void 0 : node.firstChild);
  render(
    /*#__PURE__*/ React.createElement(WaveEffect, {
      target: node,
      className: className,
    }),
    holder,
